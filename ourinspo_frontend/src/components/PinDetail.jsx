...
const PinDetail = ({user}) => {
  ...
  if(!pinDetail) return <Spinner message="Loading pin..." />
    ...
    let alreadySaved = pinDetail.save?.filter((pinDetail) => pinDetail?.postedBy?._id === userInfo);
  ...
  return (
    ...
    <div className='flex xl:flex-row flex-col m-auto bg-white max-w-[1500px] rounded-[32px]'>
      <div className='flex justify-center items-center md:items-start lg:flex-[0.5] flex-initial'>
      ...
      <div className='w-full p-5 flex-1 xl:min-w-620'>
        ...
        <div className='max-h-370 overflow-y-auto'>
          {pinDetail?.comments?.map((comment, i)=>(
            ...
            <Link to={`/user-profile/${comment.postedBy?._id}`}> <img 
